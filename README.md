...
To optimize the flowableSimpleDemoApplication application for production, run:
...
Then navigate to [http://localhost:8558](http://localhost:8558) in your browser.
