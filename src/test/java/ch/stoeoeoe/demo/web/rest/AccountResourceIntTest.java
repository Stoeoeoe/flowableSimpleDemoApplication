package ch.stoeoeoe.demo.web.rest;

import ch.stoeoeoe.demo.config.Constants;
import ch.stoeoeoe.demo.FlowableSimpleDemoApplicationApp;
import ch.stoeoeoe.demo.domain.Authority;
import ch.stoeoeoe.demo.domain.User;
import ch.stoeoeoe.demo.repository.AuthorityRepository;
import ch.stoeoeoe.demo.repository.UserRepository;
import ch.stoeoeoe.demo.security.AuthoritiesConstants;
import ch.stoeoeoe.demo.service.MailService;
import ch.stoeoeoe.demo.service.dto.UserDTO;
import ch.stoeoeoe.demo.service.dto.PasswordChangeDTO;
import ch.stoeoeoe.demo.web.rest.errors.ExceptionTranslator;
import ch.stoeoeoe.demo.web.rest.vm.KeyAndPasswordVM;
import ch.stoeoeoe.demo.web.rest.vm.ManagedUserVM;
import ch.stoeoeoe.demo.service.UserService;
...
@SpringBootTest(classes = FlowableSimpleDemoApplicationApp.class)
