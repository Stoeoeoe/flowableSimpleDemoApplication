package ch.stoeoeoe.demo.repository;

import ch.stoeoeoe.demo.FlowableSimpleDemoApplicationApp;
import ch.stoeoeoe.demo.config.Constants;
import ch.stoeoeoe.demo.config.audit.AuditEventConverter;
import ch.stoeoeoe.demo.domain.PersistentAuditEvent;
...
import static ch.stoeoeoe.demo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
